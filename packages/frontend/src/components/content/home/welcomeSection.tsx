...
const WelcomeSection = () => (
	<>
		<div className="md:mx-auto grid-item-1 place-self-center">
			<div className="isometric5 font-extrabold">5</div>
			<h1
				className="
						text-6xl
						font-bold
			...
			<h3 className="hp1 text-2xl text-gray-800 sm:text-2xl md:text-4xl">
				5.2 release (2021)
			</h3>
			<div className="desc">
				<p className="text-base sm:text-base text-gray-800 md:text-2xl lg:text-2xl">
